...
public class AgregarRegistroActivity extends AppCompatActivity {
    ...
    private EditText pdescripcion, pcantidad, pperiocidad;
    Spinner ptiempo;
   private FloatingActionButton saveBtn;
    ...
    private String descripcion, cantidad, tiempo, periocidad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pdescripcion = findViewById(R.id.txtdescrip);
        pcantidad = findViewById(R.id.txtcantidad);
        //ptiempo= findViewById(R.id.spintiempo);
        pperiocidad = findViewById(R.id.txtperiocidad);

        ptiempo = (Spinner)findViewById(R.id.spintiempo);
    ...
    private void inputData(){
        //get data
        descripcion = ""+pdescripcion.getText().toString().trim();
        cantidad = ""+pcantidad.getText().toString().trim();
       // tiempo = ""+ptiempo.getText().toString().trim();
        tiempo = (String) ptiempo.getAdapter().toString().trim();
        periocidad = ""+pperiocidad.getText().toString().trim();
